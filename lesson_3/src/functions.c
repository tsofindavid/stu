...
// Poznamka: pole 'img' je 1D pole, ktore predstavuje pixely obrazku (pixely su
// v nom usporiadane tak, ako idu v obrazku po riadkoch)
void print_image(const double *img, const unsigned int img_width,
